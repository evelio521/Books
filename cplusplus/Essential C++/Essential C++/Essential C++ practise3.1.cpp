...
int main()
{
	ifstream ifile("C:\\Users\\liuxiuyu\\Desktop\\column.txt");
	ofstream ofile("C:\\Users\\liuxiuyu\\Desktop\\column.map");
	if(!ifile||!ofile){
 ...
 void initialize_exclusion_set(set<string>&exs){
	 ...
	 "the","and","but","that","then","are","been","can",
	 "a","could","did","for","of","had","have","him","his",
